...
In the [Start](https://docs.unity3d.com/ScriptReference/MonoBehaviour.Start.html) function we will apply an initial rotation designated by the developer through the interface. To apply rotations we will add to the [euler angles](https://docs.unity3d.com/ScriptReference/Transform-eulerAngles.html) of the [transform](https://docs.unity3d.com/ScriptReference/Transform.html ) rotation in the z axis.
...
En la función [Start](https://docs.unity3d.com/ScriptReference/MonoBehaviour.Start.html) aplicaremos una rotación inicial designada por el desarrollador a través de la interfaz. Para aplicar rotaciones sumaremos a los [ángulos de euler](https://docs.unity3d.com/ScriptReference/Transform-eulerAngles.html) del [transform](https://docs.unity3d.com/ScriptReference/Transform.html) la rotación en el eje z.
